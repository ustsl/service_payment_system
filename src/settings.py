...
AIHANDLER_PAYMENT_TOKEN = os.getenv("AIHANDLER_CRYPTOCLOUD_TOKEN")
QUICKSPEAK_PAYMENT_TOKEN = os.getenv("QUICKSPEAK_CRYPTOCLOUD_TOKEN")

AIHANDLER_SERVICE_TOKEN = os.getenv("AIHANDLER_SERVICE_TOKEN_")
QUICKSPEAK_SERVICE_TOKEN = os.getenv("QUICKSPEAK_SERVICE_TOKEN_")

AIHANDLER_SERVICE_URL = os.getenv("AIHANDLER_SERVICE_URL")
QUICKSPEAK_SERVICE_URL = os.getenv("QUICKSPEAK_SERVICE_URL_")
...
TEST_DATABASE_URL = env.str(
    "TEST_DATABASE_URL",
    default=f"postgresql+asyncpg://{DB_USER_TEST}:{DB_PASSWORD_TEST}@{DB_HOST_TEST}/{DB_NAME_TEST}",
)
